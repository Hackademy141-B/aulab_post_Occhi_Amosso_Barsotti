                    ...
                    <div class="card  shadow  border border-3  rounded-4">
                        ...
                        <div class="card-body ">
                            ...
                            <a href="{{ route('article.byCategory', ['category' => $article->category->id]) }}"
                                class="small text-muted  text-capitalize text-truncate"><b>Categoria:</b>
        ...
        <div class="container ">
            <div class="row ">
                <div class="col-12 col-md-3 ">
                    ...
                    <ul class="ulfooter">
                        <li><a class="link-offset-2 link-underline link-underline-opacity-0 text-light"
                                href="#">About Us</a></li>
                        <li><a
                                class="link-offset-2 link-underline link-underline-opacity-0 text-light"href="#">Service</a>
                        </li>
                        <li><a class="link-offset-2 link-underline link-underline-opacity-0 text-light"href="#">Privacy
                                Policy</a></li>
                        <li><a class="link-offset-2 link-underline link-underline-opacity-0 text-light"href="#">Affiliate
                                Program</a></li>
                    </ul>
                </div>
                <div class="col-12 col-md-3">
                    ...
                    <ul class="ulfooter">
                        <li><a class="link-offset-2 link-underline link-underline-opacity-0 text-light"href="#">About
                                Us</a></li>
                        <li><a
                                class="link-offset-2 link-underline link-underline-opacity-0 text-light"href="#">Service</a>
                        </li>
